...
import 'package:Nymble/Helpers/playlist.dart';
import 'package:Nymble/Screens/Player/audioplayer.dart';
import 'package:Nymble/Services/isolate_service.dart';
...
class AudioPlayerHandlerImpl extends BaseAudioHandler
  ...
  void _playbackError(err) {
    Logger.root.severe('Playback Error from audio service: ${err.code}', err);
  ...
  void _onError(err, stacktrace, {bool stopService = false}) {
    Logger.root.severe('Error from audio service: ${err.code}', err);
    if (stopService) stop();
  }
