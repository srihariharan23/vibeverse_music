...
import 'package:Nymble/Helpers/picker.dart';
import 'package:Nymble/Services/ext_storage_provider.dart';
...
class _BackupAndRestorePageState extends State<BackupAndRestorePage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/NymbleMusic/Backups',
  ) as String;
              ...
              trailing: TextButton(
                ...
                onPressed: () async {
                  autoBackPath = await ExtStorageProvider.getExtStorage(
                        dirName: 'NymbleMusic/Backups',
                        writeAccess: true,
                      ) ??
                      '/storage/emulated/0/NymbleMusic/Backups';
